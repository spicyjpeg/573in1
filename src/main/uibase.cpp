...
static const uint32_t _BUTTON_MAPPINGS[NUM_BUTTON_MAPS][NUM_BUTTONS]{
	{
		...
		0
			| sys573::JAMMA_P1_START
			| sys573::JAMMA_P2_START
			| sys573::JAMMA_P1_BTN1
			| sys573::JAMMA_P2_BTN1,
		sys573::JAMMA_TEST | sys573::JAMMA_SERVICE
	}, {
		// MAP_DDR_CAB
		sys573::JAMMA_P1_BTN2  | sys573::JAMMA_P2_BTN2,
		sys573::JAMMA_P1_BTN3  | sys573::JAMMA_P2_BTN3,
		sys573::JAMMA_P1_START | sys573::JAMMA_P2_START,
		sys573::JAMMA_TEST     | sys573::JAMMA_SERVICE
	}, {
		// MAP_DDR_SOLO_CAB
		sys573::JAMMA_P1_BTN5,
		sys573::JAMMA_P2_BTN5,
		sys573::JAMMA_P1_START,
		sys573::JAMMA_TEST | sys573::JAMMA_SERVICE
	}, {
		// MAP_DM_CAB
